...
import repack.org.bouncycastle.jce.provider.X509CertPairParser;
...
import repack.org.bouncycastle.x509.X509CertificatePair;
 ...
 * {@link repack.org.bouncycastle.jce.X509LDAPCertStoreParameters} with the given
 * information of the subject (for all kind of certificates) or issuer (for
 * CRLs), respectively, if a {@link repack.org.bouncycastle.x509.X509CertStoreSelector} or
 * {@link repack.org.bouncycastle.x509.X509AttributeCertificate} is given with that
 * details.
 * <p/>
...
//    }
     ...
     * {@link repack.org.bouncycastle.x509.X509CertStoreSelector} of the given
     * selector.
     *
     * @param xselector             The selector with the search criteria.

...
import repack.org.bouncycastle.asn1.x9.X9ECPoint;
...
import repack.org.bouncycastle.jce.ECGOST3410NamedCurveTable;
    ...
    implements ECPublicKey, ECPointEncoder
{
        ...
        ECPublicKeySpec     spec)
    {
        ...
        else
        {
            if (q.getCurve() == null)
            {
                repack.org.bouncycastle.jce.spec.ECParameterSpec s = ProviderUtil.getEcImplicitlyCa();
    ...
    public repack.org.bouncycastle.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
            if (q instanceof repack.org.bouncycastle.math.ec.ECPoint.Fp)
            {
                return new repack.org.bouncycastle.math.ec.ECPoint.Fp(null, q.getX(), q.getY());
            }
            else
            {
                return new repack.org.bouncycastle.math.ec.ECPoint.F2m(null, q.getX(), q.getY());
            }
        }
    ...
    public repack.org.bouncycastle.math.ec.ECPoint engineGetQ()
    {
        return q;
    }

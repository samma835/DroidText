    ...
    implements java.security.cert.X509Extension
{
    ...
    */
    ...
    public byte[] getExtensionValue(String oid)
    {
        ...
        if (exts != null)
        {
            repack.org.bouncycastle.asn1.x509.X509Extension   ext = exts.getExtension(new DERObjectIdentifier(oid));
        ...
        boolean critical)
    {
        ...
        if (extensions != null)
        {
            ...
            while (e.hasMoreElements())
            {
                ...
                repack.org.bouncycastle.asn1.x509.X509Extension ext = extensions.getExtension(oid);

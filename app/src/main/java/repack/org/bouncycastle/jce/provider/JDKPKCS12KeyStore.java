    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            repack.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo eIn = new repack.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo((ASN1Sequence)b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            repack.org.bouncycastle.asn1.pkcs.PrivateKeyInfo pIn = new repack.org.bouncycastle.asn1.pkcs.PrivateKeyInfo((ASN1Sequence)b.getBagValue());
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            repack.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new repack.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);

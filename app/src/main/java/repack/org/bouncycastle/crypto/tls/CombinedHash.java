...
class CombinedHash implements Digest
{
    ...
    /**
     * @see repack.org.bouncycastle.crypto.Digest#getAlgorithmName()
     */
    ...
    /**
     * @see repack.org.bouncycastle.crypto.Digest#getDigestSize()
     */
    ...
    /**
     * @see repack.org.bouncycastle.crypto.Digest#update(byte)
     */
    ...
    /**
     * @see repack.org.bouncycastle.crypto.Digest#update(byte[],int,int)
     */
    ...
    /**
     * @see repack.org.bouncycastle.crypto.Digest#doFinal(byte[],int)
     */
    ...
    /**
     * @see repack.org.bouncycastle.crypto.Digest#reset()
     */
    public void reset()
    {
        md5.reset();

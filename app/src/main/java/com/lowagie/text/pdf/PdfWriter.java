...
// [C6] Actions (open and additional)
    ...
    /** @see com.lowagie.text.pdf.interfaces.PdfDocumentActions#setOpenAction(String) */
...
//  [C11] Output intents
     ...
     * @throws IOException on error
     */
    public void setOutputIntents(String outputConditionIdentifier, String outputCondition, String registryName, String info) throws IOException {
        getExtraCatalog();
   ...
   /**
    ...
    public void setOutputIntents(String outputConditionIdentifier, String outputCondition, String registryName, String info, byte destOutputProfile[]) throws IOException {
        setOutputIntents(outputConditionIdentifier, outputCondition, registryName, info, null);
    }
...
//  [F1] PdfEncryptionSettings interface
    ...
    /** @see com.lowagie.text.pdf.interfaces.PdfEncryptionSettings#setEncryption(Certificate[], int[], int) */
